...
// and unit-tested in environments without an Android SDK installed. Every
// rule of the game -- lane movement, procedural rooftops, obstacles,
// powerups, scoring/speed, missions, daily challenges, achievements, the
// plates economy/shop, and save-game serialization -- lives here.
include(":core")
...
// the line below; `gradle :core:test` keeps working either way thanks to

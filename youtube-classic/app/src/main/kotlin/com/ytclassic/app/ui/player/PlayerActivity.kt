package com.ytclassic.app.ui.player
...
import com.ytclassic.app.data.model.CommentUi
import com.ytclassic.app.databinding.ActivityPlayerBinding
import com.ytclassic.app.download.DownloadService
import com.ytclassic.app.network.LikeStatus
import com.ytclassic.app.playback.PlaybackService
import com.ytclassic.app.playback.SponsorBlockController
import com.ytclassic.app.playback.StreamSelector
import com.ytclassic.app.util.Formatters
...
class PlayerActivity : AppCompatActivity() {
    ...
    private fun setupStaticClickListeners(url: String) {
        ...
        binding.channelRow.setOnClickListener {
            ...
            startActivity(
                Intent(this, com.ytclassic.app.ui.channel.ChannelActivity::class.java)
                    .putExtra(com.ytclassic.app.ui.channel.ChannelActivity.EXTRA_CHANNEL_URL, channelUrl),
            )
        }
    }
    ...
    private fun requireCookieOrPromptLogin(action: (String) -> Unit) {
        ...
        if (cookie.isNullOrBlank()) {
            ...
            startActivity(Intent(this, com.ytclassic.app.auth.LoginActivity::class.java))
        } else {
            action(cookie)
        }
    }

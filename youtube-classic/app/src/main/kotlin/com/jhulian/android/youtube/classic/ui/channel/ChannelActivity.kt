package com.jhulian.android.youtube.classic.ui.channel
...
import com.jhulian.android.youtube.classic.data.model.toVideoUi
import com.jhulian.android.youtube.classic.databinding.ActivityChannelBinding
...
import com.jhulian.android.youtube.classic.ui.common.VideoListAdapter
        ...
        lifecycleScope.launch {
            try {
                ...
                binding.channelSubs.text = if (data.subscriberCount > 0) {
                    "${com.jhulian.android.youtube.classic.util.Formatters.compactCount(data.subscriberCount)} subscribers"
                } else {
                    ""
                }

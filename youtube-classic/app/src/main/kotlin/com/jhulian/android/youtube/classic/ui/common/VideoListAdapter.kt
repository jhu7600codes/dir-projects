...
import com.jhulian.android.youtube.classic.databinding.ItemVideoBinding
...
class VideoListAdapter(
    ...
    class VideoViewHolder(private val binding: ItemVideoBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(video: VideoUi, onClick: (VideoUi) -> Unit, onOverflowClick: (VideoUi, android.view.View) -> Unit) {
            ...
            if (video.isLive) {
                binding.duration.setBackgroundResource(com.jhulian.android.youtube.classic.R.drawable.bg_live_badge)
                binding.duration.text = "LIVE"
                binding.duration.visibility = android.view.View.VISIBLE
            } else if (!video.durationText.isNullOrBlank()) {
                binding.duration.setBackgroundResource(com.jhulian.android.youtube.classic.R.drawable.bg_duration_badge)
            ...
            Glide.with(binding.thumbnail)
                ...
                .placeholder(com.jhulian.android.youtube.classic.R.color.yt_chip_background)
                .into(binding.thumbnail)

            Glide.with(binding.channelAvatar)
                .load(video.channelAvatarUrl)
                .placeholder(com.jhulian.android.youtube.classic.R.drawable.ic_account_circle)

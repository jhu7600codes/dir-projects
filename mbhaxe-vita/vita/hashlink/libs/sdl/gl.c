...
#ifdef HL_VITA
// vitaGL's symbols are real, statically-linkable functions (like GLES
// targets, unlike desktop where these are runtime-loaded via
// SDL_GL_GetProcAddress) - so, same as HL_GLES, no loading needed
#	define GL_IMPORT(fun, t)
// unlike real GLES3, vitaGL *does* implement glFramebufferTexture,
// glPolygonMode, glClearDepth and glGetQueryObjectiv as real desktop-style
// entry points, so those are left alone here rather than reusing the
// HL_GLES stub list above - this is only what vitaGL genuinely lacks.
// Heaps features that would hit these (multi-render-target passes, 3D/
// texture-array sampling, GPU timer queries, MSAA render targets,
// compressed-texture streaming updates, integer vertex attributes) will
// hl_error() instead of silently misrendering.
#	define VGL_NOT_SUPPORTED hl_error("Not supported by vitaGL")
#	define glBindImageTexture(...) VGL_NOT_SUPPORTED
#	define glDispatchCompute(...) VGL_NOT_SUPPORTED
#	define glMemoryBarrier(...) VGL_NOT_SUPPORTED
#	define glTexImage2DMultisample(...) VGL_NOT_SUPPORTED
#	define glTexImage3D(...) VGL_NOT_SUPPORTED
#	define glTexSubImage3D(...) VGL_NOT_SUPPORTED
#	define glCompressedTexImage3D(...) VGL_NOT_SUPPORTED
#	define glCompressedTexSubImage2D(...) VGL_NOT_SUPPORTED
#	define glCompressedTexSubImage3D(...) VGL_NOT_SUPPORTED
#	define glFramebufferTextureLayer(...) VGL_NOT_SUPPORTED
#	define glDrawBuffers(...) VGL_NOT_SUPPORTED
#	define glRenderbufferStorageMultisample(...) VGL_NOT_SUPPORTED
#	define glVertexAttribIPointer(...) VGL_NOT_SUPPORTED
#	define glGetQueryObjectui64v(...) VGL_NOT_SUPPORTED
#	define glQueryCounter(...) VGL_NOT_SUPPORTED
#	define glColorMaski(...) VGL_NOT_SUPPORTED
#	define glBindFragDataLocation(...) VGL_NOT_SUPPORTED
#endif

...
class Settings {
	...
	#elseif vita
	// ux0:data is guaranteed writable regardless of how the app was installed;
	// app0: (cwd) is the read-only VPK contents. See vita/VITA_PORT.md.
	public static var settingsDir = "ux0:data/MBHAXEVITA";
	#else
